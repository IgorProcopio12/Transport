...
<html>
    <head>
        ...
        <title>Pesquisa de Tanques</title>
    </head>
    <body>
        <style>
            body {
        ...
        <table border="8" class="table table-dark">
            ...
            <c:forEach items="${tanques}" var="tanque">
                <tr>
                    <td><c:out value="${tanque.codigo}" /></td>
                    <td><c:out value="${tanque.descricao}" /></td>
                    <td><a href="ManterTanqueController?acao=prepararOperacao&operacao=Editar&idTanque=<c:out value="${tanque.codigo}"/>">Editar</a></td>
                    <td><a href="ManterTanqueController?acao=prepararOperacao&operacao=Excluir&idTanque=<c:out value="${tanque.codigo}"/>">Excluir</a></td>
                </tr>
            </c:forEach>
        </table>
        <form action="ManterTanqueController?acao=prepararOperacao&operacao=Incluir"
              method="post">
