...
<html>
    <head>
        ...
        <title>Pesquisa de Abastecimentos</title>
    </head>
    <body>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container"><br><br>
                <h1 class="display-10" align="center">Registros de Abastecimento</h1>
            </div>
        </div>
        <table border="8" class="table table-dark">
            <tr>
                <th>Código Abastecimento</th>   
            ...
            <c:forEach items="${abastecimentos}" var="abastecimento">
                <tr>
                    <td><c:out value="${abastecimento.codigo}" /></td>
                    <td><c:out value="${abastecimento.funcionario.nome}" /></td>
                    <td><c:out value="${abastecimento.garagem.descricao}" /></td>
                    <td><c:out value="${abastecimento.carro.numero}" /></td>
                    <td><c:out value="${abastecimento.quantidade}" /></td>
                    
                    <td><a href="VisualizarAbastecimentoController?acao=prepararOperacao&operacao=Visualizar&idAbastecimento=<c:out value="${abastecimento.codigo}"/>">Visualizar</a></td>
                </tr>
            </c:forEach>
        </table>
        <form action="ManterAbastecimentoController?acao=prepararOperacao&operacao=Incluir"
              method="post">
