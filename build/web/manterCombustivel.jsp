            ...
            <form action="ManterBombaController?acao=confirmarOperacao&operacao=${operacao}" method="POST" name="frmManterBomba" class="needs-validation bg-light" novalidate>
                <div class="form-row">
                    <div class="col-md-2 mb-3">
                        ...
                        <input type="text" class="form-control" name="codigo" value="${combustivel.codigo}" <c:if test="${operacao !='Incluir'}"> readonly</c:if> class="form-control" id="validationCustom01" required>
                        </div>        
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom02">Descricao</label>
                                <input type="text" class="form-control" name="descricao" value="${combustivel.descricao}" <c:if test="${operacao =='Excluir'}"> readonly</c:if> class="form-control" id="validationCustom02" required>
                        </div>
                    </div>    
                </div>
        </div>            
        <div class="d-flex justify-content-center">
            <input type="submit" value="Processar" class="btn btn-success col-md-1">
