...
<html>
    ...
    <body>
        ...
        <div class="form-group d-flex justify-content-center">       
            <form action="ManterAbastecimentoController?acao=confirmarOperacao&operacao=${operacao}" method="POST" name="frmManterAbastecimento" class="needs-validation bg-light" novalidate>
                <div class="form-row">
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <c:forEach items="${funcionarios}" var="funcionario">
                                <option value="${funcioanrio.idFuncionario}" <c:if test="${operacao =='Excluir'}"> disabled</c:if>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="bomba" class="custom-select" id="validationCustom05" required>
                            ...
                            <c:forEach items="${bombas}" var="bomba">
                                <option value="${bomba.codigo}" <c:if test="${operacao =='Excluir'}"> disabled</c:if>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="carro" class="custom-select" id="validationCustom06" required>
                            ...
                            <c:forEach items="${carros}" var="carro">
                                <option value="${carro.numero}" <c:if test="${operacao =='Excluir'}"> disabled</c:if>
        ...
        <div class="d-flex justify-content-center">
            ...
            <a href="index.jsp" value="Cancelar" class="btn btn-danger col-md-1">Cancelar</a>
        </div>
