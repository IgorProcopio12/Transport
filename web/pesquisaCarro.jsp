    ...
    <body>
        ...
        <table border="8" class="table table-dark">
            ...
            <c:forEach items="${carros}" var="carro">
                <tr>
                    <td><c:out value="${carro.numero}" /></td>
                    <td><c:out value="${carro.placa}" /></td>
                    <td><c:out value="${carro.garagem.descricao}" /></td>
                    <td><a href="ManterCarroController?acao=prepararOperacao&operacao=Editar&idCarro=<c:out value="${carro.numero}"/>">Editar</a></td>
                    <td><a href="ManterCarroController?acao=prepararOperacao&operacao=Excluir&idCarro=<c:out value="${carro.numero}"/>">Excluir</a></td>
                </tr>
            </c:forEach>
        </table>
        <form action="ManterCarroController?acao=prepararOperacao&operacao=Incluir"
              method="post">
