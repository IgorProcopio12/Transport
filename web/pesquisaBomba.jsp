...
<html>
    <head>
        ...
        <title>Pesquisa de Bombas</title>
    </head>
    <body>
        <style>
            body {
        ...
        <table border="8" class="table table-dark">
            ...
            <c:forEach items="${bombas}" var="bomba">
                <tr>
                    <td><c:out value="${bomba.codigo}" /></td>
                    <td><c:out value="${bomba.descricao}" /></td>
                    <td><a href="ManterBombaController?acao=prepararOperacao&operacao=Editar&idBomba=<c:out value="${bomba.codigo}"/>">Editar</a></td>
                    <td><a href="ManterBombaController?acao=prepararOperacao&operacao=Excluir&idBomba=<c:out value="${bomba.codigo}"/>">Excluir</a></td>
                </tr>
            </c:forEach>
        </table>
        <form action="ManterBombaController?acao=prepararOperacao&operacao=Incluir"
              method="post">
